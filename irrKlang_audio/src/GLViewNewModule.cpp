...
void GLViewNewModule::onCreate()
{
   ...
   //At this point, all the managers are initialized. That is, the engine is fully initialized.
	...
	ISoundSource* noise = Engine->addSoundSourceFromFile("../irrKlang/irrKlang-64bit-1.6.0/media/imperial-march-ringtone.mp3");
	noise->setDefaultVolume(0.1f);
	ISound* music_main = Engine->play2D(noise, true);
...
void Aftr::GLViewNewModule::loadMap()
{
   ...
   wo->setPosition( Vector( 250,0, -200) );
   wo->setLabel( "Sky Box" );
